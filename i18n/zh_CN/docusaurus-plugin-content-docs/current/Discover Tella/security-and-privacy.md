...
| 日期 | Audited by | Platforms audited  | 链接      |
| -----|----------|----|-----------|
...
| 标题                                               | 严重性    | 平台 | 状态      |
|-----------------------------------------------------|-------------|-------------|-------------|
| Require re-authentication for changing key security settings | Moderate      | 常规 | Planning |
| Improve webview implementation                      |  Moderate   | iOS       | Resolved |
| Improve GitHub practices (merging to main and tags) | 低         | Android, Android FOSS | Resolved (pending re-test) |
| Increase PBKDF2 iteration counts.                   | 低         | Android, Android FOSS | Soon |
| Do not allow clear-text traffic in Android manifest.| 低         | Android, Android FOSS | Resolved |
| Outdated 3rd-party dependencies                     | 未知         | Android, Android FOSS | Resolved |
