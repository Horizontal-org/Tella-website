...
| Numeric | ✔️ | ✔️ | ✔️ |
| Single Select  | ✔️ | ✔️ | ✔️ | 
| Multiple Select  | ✔️ | Нет | ✔️ | 
| Relationship | ✔️ | ✔️ | ✔️ |
| Single Date | ✔️ | ✔️ | ✔️ |
| Multiple Date | ✔️ | Нет | ✔️ |
| External Link | ✔️ | Нет | ✔️ |
| Rich Text | ✔️ | ✔️ | ✔️ |
| Single and Multiple Date Range | ✔️ | Нет | ✔️ |
| Attach Media (Image, Video, or Audio) | ✔️| ✔️ | ✔️ |
| Geolocation | ✔️ | Нет | ✔️ |
| Generated ID  | ✔️ | Нет | ✔️ |
...
|------|------|------|------|
| Отправить | Send the filled form to the connected server. | Да | Да |
| Save as draft | Save a form that's not completed.  | Да | Да |
| Submit later | Mark a form as ready and send it to the Outbox tab.  | Да | Да |
| Drafts Tab | A tab with all drafts. Drafts can be edited or deleted.  | Да | Да |
| Outbox Tab | A tab with forms ready to submit. Forms on the outbox tab can be edited or deleted.  | Да | Да |
| Submitted Tab | A tab with all forms that have been successfully sent to the server. Submitted forms can be deleted.  | Да | Да |
| Pause/Resume submission | Users can manually pause a submission and resume it when ready.  | Да | Нет |
| Automatically pause submission when offline | Submissions will be sent to the Outbox tab if submission fails due to connectivity issues.  | Да | Да |
