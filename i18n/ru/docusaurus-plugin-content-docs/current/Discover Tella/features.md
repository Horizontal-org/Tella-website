...
|----------------|-------------|-------------------|---------------|----------------|
| Изображение          | Crop        | ✔️                | ✔️            | ✔️             |
| Изображение          | Rotate      | ✔️                | ✔️            | ✔️             |
| Изображение          | Flip        | ✔️                | Not yet       | ✔️             |
| Изображение          | Auto-zoom        | ✔️                | Not yet       | ✔️        |
| Видео          | Trim        | Not yet       | ✔️          | Not yet        |
| Видео          | Rotate      | Not yet       | ✔️          | Not yet        |
| Аудио          | Trim        | Not yet           |  ✔️          | Not yet        |
