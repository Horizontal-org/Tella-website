...
| तारीख | Audited by | Platforms audited  | Link      |
| -----|----------|----|-----------|
...
| Title                                               | Severity    | Platform | स्थिति      |
|-----------------------------------------------------|-------------|-------------|-------------|
| Require re-authentication for changing key security settings | Moderate      | सामान्य | Planning |
...
| Outdated 3rd-party dependencies                     | अनजान         | Android, Android FOSS | Resolved |
