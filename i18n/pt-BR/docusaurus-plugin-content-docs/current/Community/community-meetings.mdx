...
:::warning Importante ~~Para garantir a segurança de todos os participantes, qualquer pessoa que se juntar às chamadas da comunidade Tella concorda em cumprir o [Código de Conduta da Horizontal](https://horizontal-org.slite.com/app/docs/E33mV5cWaJhd8x/Horizontal-Code-of-Conduct). Por favor, reserve um tempo para se familiarizar com ele.~~ :::
