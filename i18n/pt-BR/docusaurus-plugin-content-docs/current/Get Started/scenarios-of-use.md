...
## Data collection for organizations {#data-collection-for-organizations}
...
- [Server Connections](/for-organizations): Send information directly to Tella Web, Open Data Kit(ODK), Uwazi, Google Drive, Nextcloud or Dropbox. Some available features include structured submissions from multiple contributors, even in different locations. All server connections are offline-first.
...
- [Organizational deployment support](/faq#deploying-tella): We can help you decide what's the best security configuration for your users on the ground, choose a server connection, and help train your users. 
...
- [Nearby Sharing](/nearby-sharing): For sharing files locally, anonymously, between 2 devices with Tella, directly from one encrypted container to another.

## Demonstrations, protests or raids {#demonstrations-protests-or-raids}
...
- [Quick delete](/features#quick-delete): To fully delete all content of your Tella vault. 
- [Back up your files](/features#backup-files): Take into account that if you delete the content of your Tella vault, there is no way to restore it  (unless your files have been backed up to another location).
- [Restrict unlock attempts](/features#restrict-unlocking-attempts): To reduce the risk of people trying to brute-force their access to Tella.
- [Camouflage](/features#camouflage): If having Tella on your phone might raise suspicion, you can disguise it as another app.



## Rural or low-connectivity areas {#rural-or-low-connectivity-areas}

We build Tella [centering the needs of people that don't have a reliable internet connection](/accessibility). Some helpful features might be:
- [Offline data collection](features#offline-data-collection): All our server connections are offline first, users on the ground can set up their server connection and save submissions either on Drafts or the Outbox tab, so those can be submitted as soon as the phone regains internet connection.
- [Nearby Sharing](/nearby-sharing): For sharing files locally between 2 devices with Tella, directly from one encrypted container to another.
