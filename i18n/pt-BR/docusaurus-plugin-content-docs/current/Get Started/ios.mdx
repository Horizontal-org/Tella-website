...
Siga [este link](https://apps.apple.com/us/app/tella-document-protect/id1598152580) para encontrar o Tella na App Store ou procure por “Tella” na App Store.
...
### Connected to server {/* #connect-to-a-server */}
