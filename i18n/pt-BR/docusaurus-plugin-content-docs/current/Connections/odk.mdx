...
:::info A conexão ODK não está disponível no Tella para iOS. :::
...
- **URL do Servidor**: A URL do seu servidor. Por exemplo, `kc.kobotoolbox.org` caso esteja usando o servidor público do KoboToolbox. Se o servidor requerer autenticação de usuário, toque no botão **Avançado** e entre o seu **Nome de usuário** e **Senha**. O administrador do seu servidor deve fornecer todas essas informações para você.
...
| **Tipo de pergunta**                                   | **Tella Android** |
| ------------------------------------------------------ | ----------------- |
| Selecione Um                                           | ✔️                |
| Selecione Muitos                                       | ✔️                |
| Texto                                                  | ✔️                |
...
| Arquivo                                                | ✔️                |
| Nota                                                   | ✔️                |
| Código de Barras / QR Code                             | No                |
| Confirmação                                            | ✔️                |
| Avaliação                                              | ✔️                |
| Matriz de Perguntas                                    | No                |
| Classificação                                          | ✔️                |
| Calcular                                               | No                |
| Oculto                                                 | No                |
| Intervalo                                              | No                |
