...
:::tip If you need help figuring out if Nearby Sharing is best for your use-case, [contact us](/contact-us)! :::

:::tip If you are trying to share files to the organization you are working with, or if you are not in the same physical location as the person you want to exchange files with, [Tella's server connections](/for-organizations) could be helpful:
