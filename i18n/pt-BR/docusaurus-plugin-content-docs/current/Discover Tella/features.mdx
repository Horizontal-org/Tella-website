...
## [Configuração do tempo limite de bloqueio]{1} {/* #lock-timeout-configuration */}
...
## [Modo silencioso da câmera]{1} {/* #camera-silent-mode */}
...
## [Restrição de tentativas de desbloqueio]{1} {/* #restrict-unlocking-attempts */}
...
| **Media Type** | **Funcionalidade** | **Tella para Android** | **Tella para iOS** | **Tella para iOS** |
| -------------- | ------------------ | ---------------------- | ------------------ | ------------------ |
| Imagem         | Crop               | ✔️                     | ✔️                 | ✔️                 |
| Imagem         | Taxa               | ✔️                     | ✔️                 | ✔️                 |
| Imagem         | Flip               | ✔️                     | Ainda não          | ✔️                 |
| Imagem         | Auto-zoom          | ✔️                     | Ainda não          | ✔️                 |
| Vídeo          | Trim               | Ainda não              | ✔️                 | Ainda não          |
| Vídeo          | Taxa               | Ainda não              | ✔️                 | Ainda não          |
| Áudio          | Trim               | Ainda não              | ✔️                 | Ainda não          |
...
## [Importação de arquivos do dispositivo]{1} {/* #import-files-from-device */}
...
## [Abertura de arquivos no Tella]{1} {/* #open-files-in-tella */}
...
## [Personalização da tela inicial]{1} {/* #homescreen-customization */}
...
## [Modo de verificação]{1} {/* #verification-mode */}
...
## Connected to server {/* #connecting-to-servers */}
...
## [Câmera (fotos e vídeos)]{1} {/* #camera-photos-and-videos */}
...
## [Seleção da resolução de vídeo]{1} {/* #select-video-resolution */}
...
## [Gravação de Áudio]{1} {/* #audio-recorder */}
...
## [Coleta de dados offline]{1} {/* #offline-data-collection */}
