...
:::tip Saiba mais sobre [Como encontrar e baixar o Tella da Play Store](/video-tutorials#find-and-download-tella-from-the-play-store) e [Como instalar o Tella manualmente](/video-tutorials#manual-installation-of-tella) nos nossos tutoriais em vídeo. :::
...
:::note Perceba que não é possível criptografar e ocultar arquivos ou criar relatórios no Tella Web. Essas funcionalidades só estão disponíveis nos aplicativos para dispositivos móveis. O Tella Web é uma das [conexões](/connections) disponíveis para enviar dados coletados no aplicativo Tella. :::
...
:::tip Saiba mais sobre [Bloqueios do Tella](/video-tutorials#tella-locks) em nossos tutoriais em vídeo. :::
