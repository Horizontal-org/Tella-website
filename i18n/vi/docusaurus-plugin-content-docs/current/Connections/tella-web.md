...
## Khi nào nên dùng Tella Web {#when-to-use-tella-web}

Tella Web có thể là một lựa chọn phù hợp nếu:
- Bạn có khả năng tự lưu trữ Tella Web.
- Người dùng tại hiện trường sẽ chủ yếu gửi các tệp phương tiện, kèm theo một số văn bản và không cần thu thập dữ liệu có cấu trúc (biểu mẫu).
- Bạn sẽ hợp tác với Horizontal và muốn cùng một tổ chức giúp bạn cài đặt, cấu hình và bảo trì phiên bản Tella Web và ứng dụng Tella.
...
Bạn có thể xem ghi chú phát hành Tella Web [tại đây](https://github.com/Horizontal-org/tellaweb/releases).
...
Trong phần "Quản lý quyền truy cập" của màn hình "Cài đặt dự án", quản trị viên có thể chỉ định người dùng hiện có vào dự án. Nhấn vào trường "Thêm người dùng". Một menu thả xuống sẽ hiển thị tất cả người dùng trên máy chủ. Cuộn qua danh sách hoặc nhập để tìm kiếm người dùng theo tên người dùng.
Sau khi chọn người dùng để thêm vào dự án, nhấn nút "Thêm" để lưu thay đổi và cấp quyền truy cập vào dự án.
...
### Quản lý tài nguyên {#managing-resources}
...
#### Tải Tài nguyên từ kho của bạn {#pull-resources-from-your-space}
