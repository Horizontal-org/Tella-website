...
| ----------- | ---------------------------------------- | ----------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------- |
| July 2026   | Horizontal x Convocation Research+Design | Android, Android FOSS, iOS, Desktop | [View security audit](</assets/2026.07 - Horizontal x Convocation Research+Design  A Comprehensive Security Audit for Tella 3.0.0+.pdf>) |
