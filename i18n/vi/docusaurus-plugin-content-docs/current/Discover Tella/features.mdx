...
## [Cài đặt thời gian tự động khóa]{1} {/* #lock-timeout-configuration */}
...
## Chế độ im lặng của máy ảnh {/* #camera-silent-mode */}
...
## [Giới hạn số lần mở khóa]{1} {/* #restrict-unlocking-attempts */}
...
## [Chỉnh sửa Phương tiện]{1} {/* #edit-media */}
...
| **Media Type** | **Tính năng** | **Tella Android** | **Tella iOS** | Tella FOSS |
| -------------- | ------------- | ----------------- | ------------- | ---------- |
| Hình ảnh       | Crop          | ✔️                | ✔️            | ✔️         |
| Hình ảnh       | Xoay          | ✔️                | ✔️            | ✔️         |
| Hình ảnh       | Flip          | ✔️                | Chưa có       | ✔️         |
| Hình ảnh       | Auto-zoom     | ✔️                | Chưa có       | ✔️         |
| Video          | Trim          | Chưa có           | ✔️            | Chưa có    |
| Video          | Xoay          | Chưa có           | ✔️            | Chưa có    |
| Âm thanh       | Trim          | Chưa có           | ✔️            | Chưa có    |
...
## [Nhập tập tin từ thiết bị]{1} {/* #import-files-from-device */}
...
## Giữ nguyên siêu dữ liệu khi nhập tệp. {/* #preserve-metadata-when-importing */}
...
## [Tùy chỉnh màn hình chính]{1} {/* #homescreen-customization */}
...
<Info title="Liên hệ với chúng tôi">
...
## [Máy ảnh (hình ảnh và video)]{1} {/* #camera-photos-and-videos */}
...
## [Thu thập dữ liệu ngoại tuyến]{1} {/* #offline-data-collection */}
