...
import {Tip} from '@site/src/components/Admonitions';
...
10. **Offline file sharing**: Tella allows establishing a secure connection with devices that are in the same physical location and transferring files encrypted, from one Tella vault to another. [Nearby Sharing](/nearby-sharing) works fully offline, even on insecure networks or networks being surveilled, using mutual TLS to verify both devices before any file is exchanged. Nearby Sharing is available cross-platform (between Android, iOS and Desktop). [Read more about the technical security measures in Nearby Sharing](/nearby-sharing#security-measures).
...
| -----|----------|----|-----------|
| Julio de 2026 | Horizontal x Convocation Research+Design|  Android, Android FOSS, iOS, Desktop|[Ver informe](</assets/2026.07 - Horizontal x Convocation Research+Design  A Comprehensive Security Audit for Tella 3.0.0+.pdf>)|
