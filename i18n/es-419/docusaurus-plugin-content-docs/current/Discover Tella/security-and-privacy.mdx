...
2. **Cifrado en tránsito:** Todos los datos siendo transferidos entre Tella y servidores (ver [sección de Conexiones](/connections)) son cifrados a través de [Seguridad de la Capa de Transporte (TLS - Transport Layer Security)](https://en.wikipedia.org/wiki/Transport_Layer_Security). Tella hace que sea imposible enviar datos a un servidor sin cifrado TLS.
