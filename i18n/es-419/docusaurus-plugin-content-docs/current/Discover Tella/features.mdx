...
## [Configuración de tiempo de espera para bloqueo]{1} {/* #lock-timeout-configuration */}
...
## [Modo silencioso de cámara]{1} {/* #camera-silent-mode */}
...
## [Seguridad de Pantalla]{1} {/* #screen-security */}
...
## [Restringir intentos de desbloqueo]{1} {/* #restrict-unlocking-attempts */}
...
## [Editar Archivos Multimedia]{1} {/* #edit-media */}
...
## [Importar archivos desde el dispositivo]{1} {/* #import-files-from-device */}
...
## [Conservar metadatos al importar]{1} {/* #preserve-metadata-when-importing */}
...
## [Analíticas preservando la privacidad (opt-in)]{1} {/* #privacy-preserving-analytics */}
...
## [Personalización de la Pantalla de Inicio]{1} {/* #homescreen-customization */}
...
## [Cámara (fotos y videos)]{1} {/* #camera-photos-and-videos */}
...
## [Seleccionar resolución de video]{1} {/* #select-video-resolution */}
...
## [Recopilación de datos fuera de línea]{1} {/* #offline-data-collection */}
