...
:::tip Si necesitas ayuda para determinar si ODK es la mejor opción para tu caso de uso, [lee nuestra guía](/for-organizations) o [contáctanos](/contact-us)! :::
...
:::info La conexión ODK no está disponible para Tella iOS. :::
