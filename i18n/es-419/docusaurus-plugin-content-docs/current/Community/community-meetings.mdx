...
:::important Tristemente, debido a los [problemas de financiamiento que estamos transitando en Horizontal](https://donorbox.org/towards-sustainability), necesitamos pausar las llamadas comunitarias de Tella por tiempo indefinido. Si tienes dudas o necesitas apoyo, por favor [contáctanos directamente](/contact-us). :::
