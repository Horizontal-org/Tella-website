...
~~Las llamadas comunitarias de Tella tienen lugar en la instancia pública de Jitsi Meet. Jitsi no requiere registrarse y no recopila ni retiene datos sobre la(o)s usuaria(o)s. Sin embargo, <u>**el enlace a la reunión se comparte públicamente y ampliamente**</u>. Por favor ten precaución de mantener tu identidad oculta si es importante para tu seguridad (por ejemplo, puedes usar un pseudónimo) y evitar compartir cualquier información confidencial durante la llamada.~~
