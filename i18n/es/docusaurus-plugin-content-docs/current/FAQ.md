...
Tella works on Android tablets, but it is currently not available on iPad. Please [email us](mailto:contact@tella-app.org) if iPad support is important to you so that we can make it a priority.
