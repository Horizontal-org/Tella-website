...
:::note Dernière mise à jour le 25 février 2025. :::

:::info Vous pouvez lire les détails sur les détails techniques et les audits de sécurité de Tella sur notre [page Sécurité et confidentialité](/security-and-privacy). :::
