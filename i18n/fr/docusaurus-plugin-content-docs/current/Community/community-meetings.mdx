...
import {Warning} from '@site/src/components/Admonitions';

# Réunions de la communauté de Tella

<Warning>
Malheureusement, à cause des [défis financiers rencontrés par Horizontal](https://donorbox.org/towards-sustainability), nous devons mettre en pause les réunions de la communauté Tella. Si vous avez des questions ou besoin d'aide, merci [de nous contacter directement](/contact-us).
</Warning>
...
### ~~Vie privée et sécurité~~ {/* #safety-and-privacy */}

<Warning title="Important">
~~Pour assurer la sécurité de tous les participants, toute personne rejoignant la communauté Tella accepte de respecter [Le Code de Conduite d'Horizontal](https://horizontal-org.slite.com/app/docs/E33mV5cWaJhd8x/Horizontal-Code-of-Conduct). Merci de prendre le temps de vous familiariser avec ce dernier..~~
</Warning>
