...
id : dropbox
title : Dropbox 
description : Tella permet à ses utilisateurs de facilement importer des photos, vidéos et enregistrements audios sur Dropbox.
slug : /dropbox
---
...
[Dropbox](https://www.dropbox.com/) est un service commercial de stockage de fichiers en ligne qui propose des offres gratuites et payantes.

Tella permet à ses utilisateurs de se connecter à leur compte Dropbox directement depuis Tella et d'y ajouter des fichiers.

Comme les autres connexions à un serveur (comme [Tella Web](/tella-web), [Google Drive](/g-drive), [Nextcloud](/nextcloud), [Uwazi](/uwazi) ou [Open Data Kit](/odk)), se connecter à un serveur Dropbox augmente la sécurité des données stockées dans Tella en:

1. Permettant aux utilisateurs et utilisatrices de collecter des données directement dans le conteneur chiffré de Tella.
...
## Quand utiliser Dropbox {/* #when-to-use-dropbox */}
...
## Se connecter à Dropbox {/* #connect-to-dropbox */}

Prêt à se connecter à Dropbox:
...
* Connectez-vous à votre compte Dropbox dans votre navigateur.
...
## Gérer la connexion à Dropbox {/* #manage-the-dropbox-connection */}

* Sous **Paramètres ⚙️** > **Connexions** > **Dropbox** > **⫶** vous pouvez:
...
* Une fois connecté, une fenêtre "Dropbox" va apparaître dans la partie "Connections" de l'écran d'accueil. Appuyez sur cette.
