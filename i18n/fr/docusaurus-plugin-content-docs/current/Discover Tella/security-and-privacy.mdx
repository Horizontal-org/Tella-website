...
### Tella FOSS (c'est-à-dire gratuite et libre) {/* #tella-foss */}
...
### Tella FOSS (c'est-à-dire gratuite et libre) {/* #tella-ios */}
...
## Nouvelles fonctions de sécurité {/* #security-features */}
...
2. **Cryptage en transit:** Toutes les données transférées entre Tella et les serveurs (voir [Section Connexions](/connections)) sont cryptées via[Transport Layer Security (TLS)](https://en.wikipedia.org/wiki/Transport_Layer_Security). Tella rend impossible l'envoi de données à un serveur sans cryptage TLS.
...
| ------------ | ---------------------------------------- | ----------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------- |
| Juillet 2026 | Horizontal x Convocation Research+Design | Android, Android FOSS, iOS, Desktop | [View security audit](</assets/2026.07 - Horizontal x Convocation Research+Design  A Comprehensive Security Audit for Tella 3.0.0+.pdf>) |
