...
<Note>
Toutes les exportations en dehors du coffre-fort chiffré de Tella (vers un serveur connecté ou vers votre téléphone) seront non chiffrées. La seule méthode de partage de fichiers qui transfère les fichiers directement vers un autre coffre-fort chiffré est le [Partage de proximité](/features#file-management).
</Note>
...
## [Configuration du Délai de verrouillage]{1} {/* #lock-timeout-configuration */}
...
## Mode silencieux de l’appareil photo {/* #camera-silent-mode */}
...
## [Limiter les tentatives de déverrouillage]{1} {/* #restrict-unlocking-attempts */}
...
| **Media Type** | **Fonctionnalité** | **Tella Android** | **Tella iOS** | Tella FOSS (c'est-à-dire gratuite et libre) |
| -------------- | ------------------ | ----------------- | ------------- | ------------------------------------------- |
| Image          | Crop               | ✔️                | ✔️            | ✔️                                          |
| Image          | Faire pivoter      | ✔️                | ✔️            | ✔️                                          |
| Image          | Flip               | ✔️                | Pas encore    | ✔️                                          |
| Image          | Auto-zoom          | ✔️                | Pas encore    | ✔️                                          |
| Vidéo          | Trim               | Pas encore        | ✔️            | Pas encore                                  |
| Vidéo          | Faire pivoter      | Pas encore        | ✔️            | Pas encore                                  |
...
## Importer depuis l'appareil {/* #import-files-from-device */}
...
## [Ouvrir des fichiers dans Tella]{1} {/* #open-files-in-tella */}
...
## [Personnalisation de l'écran d'accueil]{1} {/* #homescreen-customization */}
...
## Se connecter aux serveurs {/* #connecting-to-servers */}
...
* Trousse de données ouvertes (ODK)
* [Uwazi](/uwazi)
* [Tella Web](/tella-web)
* Google Drive
* [Nextcloud](/nextcloud)
...
## Nearby Sharing (partage à proximité) {/* #nearby-sharing */}
...
## [Caméra (photos et vidéos)]{1} {/* #camera-photos-and-videos */}
...
## Sélectionner la résolution de la vidéo {/* #select-video-resolution */}
...
## [Enregistreur audio]{1} {/* #audio-recorder */}
...
## [Collecte de données hors ligne]{1} {/* #offline-data-collection */}
