...
import {Note, Tip, Info} from '@site/src/components/Admonitions';
...
### Can i backup the data I store in Tella? {/* #can-i-backup-the-data-i-store in-tella? */} {/* #can-i-backup-the-data-i-store-in-tella--can-i-backup-the-data-i-store-in-tella- */}
