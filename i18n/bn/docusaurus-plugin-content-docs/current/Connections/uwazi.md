...
| Numeric | ✔️ | ✔️ | ✔️ |
| Single Select  | ✔️ | ✔️ | ✔️ | 
| Multiple Select  | ✔️ | না | ✔️ | 
| Relationship | ✔️ | ✔️ | ✔️ |
| Single Date | ✔️ | ✔️ | ✔️ |
| Multiple Date | ✔️ | না | ✔️ |
| External Link | ✔️ | না | ✔️ |
| Rich Text | ✔️ | ✔️ | ✔️ |
| Single and Multiple Date Range | ✔️ | না | ✔️ |
...
|------|------|------|------|
| সাবমিট | Send the filled form to the connected server. | হ্যাঁ | হ্যাঁ |
| Save as draft | Save a form that's not completed.  | হ্যাঁ | হ্যাঁ |
| Submit later | Mark a form as ready and send it to the Outbox tab.  | হ্যাঁ | হ্যাঁ |
| Drafts Tab | A tab with all drafts. Drafts can be edited or deleted.  | হ্যাঁ | হ্যাঁ |
| Outbox Tab | A tab with forms ready to submit. Forms on the outbox tab can be edited or deleted.  | হ্যাঁ | হ্যাঁ |
| Submitted Tab | A tab with all forms that have been successfully sent to the server. Submitted forms can be deleted.  | হ্যাঁ | হ্যাঁ |
| Pause/Resume submission | Users can manually pause a submission and resume it when ready.  | হ্যাঁ | না |
| Automatically pause submission when offline | Submissions will be sent to the Outbox tab if submission fails due to connectivity issues.  | হ্যাঁ | হ্যাঁ |
