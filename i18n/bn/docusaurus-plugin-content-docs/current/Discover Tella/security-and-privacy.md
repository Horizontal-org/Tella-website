...
| তারিখ | Audited by | Platforms audited  | Link      |
| -----|----------|----|-----------|
...
| শিরোনাম                                               | প্রখরতা    | Platform | অবস্থা      |
|-----------------------------------------------------|-------------|-------------|-------------|
| Require re-authentication for changing key security settings | Moderate      | সাধারণ | Planning |
| Improve webview implementation                      |  Moderate   | iOS       | Resolved |
| Improve GitHub practices (merging to main and tags) | নিম্ন         | Android, Android FOSS | Resolved (pending re-test) |
| Increase PBKDF2 iteration counts.                   | নিম্ন         | Android, Android FOSS | Soon |
| Do not allow clear-text traffic in Android manifest.| নিম্ন         | Android, Android FOSS | Resolved |
| Outdated 3rd-party dependencies                     | অজানা         | Android, Android FOSS | Resolved |
