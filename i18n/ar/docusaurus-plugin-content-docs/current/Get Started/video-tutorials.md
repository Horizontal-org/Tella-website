...
description: الفيديوهات التعليمية لـ Tella
...
## التثبيت اليدوي لـ Tella {#manual-installation-of-tella}
...
## جمع الأدلة {#collecting-evidence}
...
## مشاركة البيانات مع تطبيقات أخرى {#sharing-data-with-other-apps}
...
## تمويه Tella {#camouflaging-tella}
...
## الميزات الأمنية الإضافية {#additional-security-features}
...
## الاتصال بالخوادم {#server-connections}

### الفيديو الكامل للاتصالات {#connections-full-video}
