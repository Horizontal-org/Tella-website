...
* ‫Tella لأندرويد، الإصدار 2.1.0 (152) والإصدارات اللاحقة
* ‫Tella لنظام iOS، الإصدار 1.1.0 (43) والإصدارات اللاحقة
...
* في التقرير، اضغط على "إرسال" لبدء عملية إرسال التقرير.
* سيتم توجيهك إلى شاشة ملخص تعرض تقدم تحميل كل ملف مرفق.
* هناك زر "حذف" لإيقاف التحميل وحذف التقرير.
* إذا كان التقرير يتم تحميله بنشاط، فإن زر "إيقاف مؤقت" يسمح لك بإيقاف التحميل مؤقتا، ويمكن استئنافه لاحقا باستخدام زر "استئناف".
* الخروج من التقرير لا يؤثر على حالة التحميل. إذا كان التقرير يتم تحميله بنشاط، ستستمر العملية.

:::info
بعد تحميل التقرير إلى Tella Web، لا يمكن حذفه من Tella Web باستخدام تطبيق Tella المحمول. حذف التقرير المرسل سيؤدي فقط إلى حذف النسخة المحلية منه، وليس التقرير على الخادم.
:::

:::info
حذف التقرير وسط عملية الإرسال سيؤدي إلى إلغاء تحميل الملفات التي لم يتم تحميلها بعد، ولكن الملفات المرسلة والملفات المرسلة جزئيا التي وصلت بالفعل إلى Tella Web لن يتم حذفها.
:::


#### صندوق الصادر {#outbox}

يحتوي صندوق الصادر على التقارير التي تم حفظها للإرسال. قد يكون هذا بسبب:

* الإرسالات الموقوفة مؤقتا
* إرسال التقارير التي توقفت بسبب مشاكل الاتصال.
* التقارير التي تم تعليمها كـ "إرسال لاحقا"


#### التقارير المرسلة {#submitted-reports}

- تعرض علامة التبويب المرسلة التقارير التي تم إرسالها بنجاح إلى خادم Tella Web.
- في علامة التبويب المرسلة، يمكنك عرض ومراجعة التقارير المرسلة.

:::info
إذا تم انقطاع الاتصال بالأنترنت، ستنتقل التقارير إلى علامة تبويب الصندوق الصادر وستحتاج إلى استئناف الإرسال يدويا.
:::
...
إذا تم تمكين التقرير التلقائي، فسيقوم Tella بإنشاء وتحميل التقارير تلقائيا كلما قمت بالتقاط صورة أو تسجيل فيديو أو تسجيل صوتي في Tella. يضمن هذا أن تقاريرك تُحمل بسلاسة دون الحاجة إلى عمل يدوي. يتم تحميل الملفات إلى نفس التقرير التلقائي إذا تم جمعها في غضون 30 دقيقة.

يمكن تمكين التقرير التلقائي من شاشة تحرير الاتصال.

:::info
يمكن تمكين التقرير التلقائي لمشروع واحد فقط في كل مرة
:::

#### الحذف التلقائي {#auto-delete}

عند تمكين التقرير التلقائي، يمكنك تمكين الحذف التلقائي، والذي يحذف تلقائيا التقارير والملفات المرتبطة بها من جهازك بعد تحميلها بنجاح إلى Tella Web. يساعدك هذا في إدارة مساحة التخزين على جهازك ويضمن عدم الاحتفاظ بالبيانات الحساسة عن غير قصد.
...
تتيح ميزة الإرسال في الخلفية استمرار عملية إرسال التقرير حتى إذا قمت بالتبديل إلى مهام أخرى داخل Tella أو إذا خرجت من Tella بالكامل. يمكن أن يعمل الإرسال في الخلفية بالتوازي مع كل من التقارير اليدوية والتلقائية، ويمكن تمكينها من شاشة تحرير الاتصال للمشروع المطلوب.

عند تمكين الإرسال في الخلفية، بغض النظر عما تفعله في Tella أو ما إذا أغلقن التطبيق، ستستمر عملية التحميل دون انقطاع. ستعمل أيضا إذا تم تمكين التقارير التلقائية وأغلقت التطبيق بعد جمع المعلومات.

عند تحميل التقارير في الخلفية، يبقى Tella غير مغلق. هذا يعني أنه إذا فتح شخص ما Tella، سيتمكن من الوصول إلى ملفاتك وتقاريرك. لقفل Tella عندما تكون التقارير تُحمّل في الخلفية، اضغط على زر "الخروج السريع" في أعلى يمين الشاشة الرئيسية لـ Tella.

إذا انقطعت عملية الإرسال بسبب ضعف الاتصال بالأنترنت أو عوامل أخرى، سيرسل Tella التقرير إلى علامة تبويب الصندوق الصادر ويعيد تشغيل التحميل تلقائيا بمجرد استعادة الهاتف لاتصال أنترنت مستقر.