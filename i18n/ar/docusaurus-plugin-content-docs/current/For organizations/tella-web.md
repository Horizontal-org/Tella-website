...
|--------|--------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------|--|
|✅|
| ✅ | تحرير التقارير (إعادة التسمية)|تحرير التقارير (إعادة التسمية)|❌|تحرير التقارير (إعادة التسمية)| 
|✅| 
| حذف التقارير  |إدارة الوصول إلى المشاريع {#managing-access-to-projects}|❌|✅|تحرير التقارير (إعادة التسمية)| 
| تحرير المشاريع (الإنشاء، إعادة التسمية، تحرير عنوان الموقع)  |إدارة الوصول إلى المشاريع {#managing-access-to-projects}|تحرير التقارير (إعادة التسمية)|✅|تحرير التقارير (إعادة التسمية)| 
| حذف المشاريع |❌|إدارة الوصول إلى المشاريع {#managing-access-to-projects}|❌|تحرير التقارير (إعادة التسمية)| 
| إدارة المستخدمين (الإنشاء، التحرير، الحذف) |❌|إدارة الوصول إلى المشاريع {#managing-access-to-projects}|❌|تحرير التقارير (إعادة التسمية)| 
| تعيين المستخدمين للمشروع |❌|إدارة الوصول إلى المشاريع {#managing-access-to-projects}|❌|تحرير التقارير (إعادة التسمية)| 
| إنشاء موارد للمساحة |❌|إدارة الوصول إلى المشاريع {#managing-access-to-projects}|تحرير التقارير (إعادة التسمية)|تحرير التقارير (إعادة التسمية)| 
| ‮إضافة/حذف موارد للمشروع |❌|✅|إدارة الوصول إلى المشاريع {#managing-access-to-projects}|تحرير التقارير (إعادة التسمية)| 
| عرض الموارد المخصصة لمشروع |في الشريط العلوي، فوق قائمة المستخدمين، يمكن للمسؤول عن الخادم الضغط على زر "إنشاء مستخدم" لإنشاء مستخدم جديد على الخادم. يلزم إدخال البريد الإلكتروني وكلمة السر وتأكيد كلمة السر والدور من أجل إنشاء المستخدمين.|في حقل كلمة السر، يساعد مقياس أمن كلمة السر المسؤولين على إنشاء كلمات سر آمنة. نقيس مستوى التعقيد لكلمة السر باستخدام مكتبة [zxcvbn](https://github.com/dropbox/zxcvbn) التي تضع في الحسبان:|إدارة الوصول إلى المشاريع {#managing-access-to-projects}|تحرير التقارير (إعادة التسمية)| 
| إنشاء المستخدمين {#creating-users} |عدم وجود كلمات سر شائعة مثل الأسماء والمدن وغيرها.|إدارة الوصول إلى المشاريع {#managing-access-to-projects}|إدارة الوصول إلى المشاريع {#managing-access-to-projects}|تحرير التقارير (إعادة التسمية)| 
| عدم وجود أنماط شائعة مثل التواريخ والتكرارات (aaa) والتسلسلات (abcd) وأنماط لوحة المفاتيح (qwertyuiop)  |يسمح Tella Web للمنظمات بنشر الموارد والمواد بشكل آمن لـ
مستخدميهم مباشرة داخل حاوية Tella المعماة. يمكن استخدام الموارد لتقديم إرشادات لجمع البيانات أو رسائل أو دلائل حول كيفية جمع البيانات.|إدارة الوصول إلى المشاريع {#managing-access-to-projects}|يمكن للمسؤولين إضافة موارد إلى المساحة عن طريق التنقل إلى **الموارد** في شريط التنقل الجانبي الأيسر. حاليا، يمكن إنشاء الموارد عن طريق تحميل ملفات PDF. نوصي بالحفاظ على حجم هذه الملفات أقل من 20 ميغابايت لضمان أن المستخدمين يمكنهم تحميلها حتى إذا كان الإنترنت بطيئا.|تحرير التقارير (إعادة التسمية)| 
