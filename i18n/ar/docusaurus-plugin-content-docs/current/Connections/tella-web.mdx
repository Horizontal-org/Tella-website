...
مثل باقي الاتصالات الأخرى ([Uwazi](/uwazi) و [Open Data Kit](/g-drive))، فإن الاتصال بـ Tella Web يعزز أمن البيانات المجمعة على Tella من خلال:
...
يمكنك الاطلاع على ملاحظات إصدار Tella Web [هنا](https://github.com/Horizontal-org/tellaweb/releases).
