...
:::info إن عنوان الموقع الذي ستحتاج إلى إرساله إلى المستخدمين يجب أن يبدو كالتالي `https://your-domain.com/p/your-project-name` :::
...
في قسم "إدارة الوصول" في شاشة "إعدادات المشروع"، يمكن للمسؤولين تعيين المستخدمين الموجودين إلى المشروع. اضغط على حقل "إضافة مستخدمين". ستعرض القائمة المنسدلة جميع المستخدمين على الخادم. قم بالتمرير عبر القائمة أو اكتب اسم مستخدم للبحث عن مستخدم ما. بعد تحديد المستخدمين المراد إضافتهم إلى المشروع، اضغط على زر "إضافة" لحفظ التغييرات ومنح الوصول إلى المشروع.

:::info تشمل القائمة الكاملة للمستخدمين الذين يمكنهم إرسال التقارير إلى المشروع المستخدمين المدرجين في هذا القسم بالإضافة إلى جميع المسؤولين عن الخوادم. :::

### إدارة الموارد {/* #managing-resources */}

يسمح Tella Web للمنظمات بنشر الموارد والمواد بشكل آمن لـ مستخدميهم مباشرة داخل حاوية Tella المعماة. يمكن استخدام الموارد لتقديم إرشادات لجمع البيانات أو رسائل أو دلائل حول كيفية جمع البيانات.
...
تتم مشاركة الموارد داخل المساحة. ضع في اعتبارك أن الموارد لا تكون متاحة للمستخدمين إلا بعد إضافتها إلى مشاريع معينة.
...
2. عن طريق الضغط على أيقونة **الموارد** على بطاقة كل مشروع على الشاشة الرئيسية لـ Tella Web.
...
:::info إذا انقطع الاتصال بالانترنت، ستنتقل التقارير إلى لسان البريد الصادر وستحتاج إلى استئناف الإرسال يدويا. :::
...
:::info يمكن تفعيل التقرير التلقائي لمشروع واحد فقط في كل مرة :::
