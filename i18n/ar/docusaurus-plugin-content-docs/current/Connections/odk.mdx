...
كما هو الشأن مع أي اتصال آخر بخادم (مثل [Tella Web](/tella-web) أو [Google Drive](/g-drive) أو [Dropbox](/dropbox) أو [Nextcloud](/nextcloud) أو [Uwazi](/uwazi))، يعزّز الاتصال بخادم ODK أمن البيانات المُجمَّعة على Tella من خلال:
...
| [إنشاء عناصر محددة من التكرارات](https://docs.getodk.org/form-logic/#generating-select-ones-from-repeats)    | ❌                  |
