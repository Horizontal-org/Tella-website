...
:::tip If you need help understand if Nearby Sharing is well-suited for your use case, [contact us](/contact-us)! :::

:::tip If you are trying to share files with an organization you are working with, or if you are not in the same physical location as the person you want to exchange files with, [Tella's server connections](/for-organizations) may be better-suited than Nearby Sharing. Tella supports the following connections:
...
:::tip Nearby Sharing does not work if either of the devices is connected to a VPN. :::
