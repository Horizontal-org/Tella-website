...
::: |
|----------------|-------------|-------------------|---------------|----------------|
| **استمارة التعليقات داخل التطبيق:**          | هناك عدة خيارات لمستخدمي Tella [للاتصال بفريق Tella](/contact-us) من أجل اقتراح تحسينات والإبلاغ عن الأخطاء والمشاكل وطلب الدعم. داخل Tella، هناك خياران:        | قص الصور وتدويرها                | ✔️            | قص الصور وتدويرها             |
...
:::      | قص الصور وتدويرها                | ✔️            | قص الصور وتدويرها             |
| **استمارة التعليقات داخل التطبيق:**          | استيراد الملفات من الجهاز {#import-files-from-device}        | قص الصور وتدويرها                | ليس بعد       | قص الصور وتدويرها             |
| **استمارة التعليقات داخل التطبيق:**          | تحليلات الحفاظ على الخصوصية (اشتراك) {#privacy-preserving-analytics}        | قص الصور وتدويرها                | ليس بعد       | قص الصور وتدويرها        |
