...
## [تهيئة مهلة القفل]{1} {/* #lock-timeout-configuration */}
...
## [تقييد محاولات فتح القفل]{1} {/* #restrict-unlocking-attempts */}
...
| **Media Type** | **الميزة** | **‫Tella Android** | **‫Tella iOS** | Tella FOSS |
| -------------- | ---------- | ------------------ | -------------- | ---------- |
| صورة           | Crop       | ✔️                 | ✔️             | ✔️         |
| صورة           | استدارة    | ✔️                 | ✔️             | ✔️         |
| صورة           | Flip       | ✔️                 | ليس بعد        | ✔️         |
| صورة           | Auto-zoom  | ✔️                 | ليس بعد        | ✔️         |
| فيديو          | Trim       | ليس بعد            | ✔️             | ليس بعد    |
| فيديو          | استدارة    | ليس بعد            | ✔️             | ليس بعد    |
| ملفات صوتية    | Trim       | ليس بعد            | ✔️             | ليس بعد    |
...
## [استيراد الملفات من الجهاز]{1} {/* #import-files-from-device */}
...
## [تحليلات الحفاظ على الخصوصية (اشتراك)]{1} {/* #privacy-preserving-analytics */}
...
## [فتح الملفات في Tella]{1} {/* #open-files-in-tella */}
...
## [تخصيص الشاشة الرئيسية]{1} {/* #homescreen-customization */}
...
## [الكاميرا (الصور والفيديوهات)]{1} {/* #camera-photos-and-videos */}
...
## يُرجى اختيار دقة الفيديو {/* #select-video-resolution */}
...
## [جمع البيانات دون الاتصال بالانترنت]{1} {/* #offline-data-collection */}
