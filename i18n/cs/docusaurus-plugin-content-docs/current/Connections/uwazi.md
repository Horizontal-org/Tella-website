...
| Numeric | ✔️ | ✔️ | ✔️ |
| Single Select  | ✔️ | ✔️ | ✔️ | 
| Multiple Select  | ✔️ | Ne | ✔️ | 
| Relationship | ✔️ | ✔️ | ✔️ |
| Single Date | ✔️ | ✔️ | ✔️ |
| Multiple Date | ✔️ | Ne | ✔️ |
| External Link | ✔️ | Ne | ✔️ |
| Rich Text | ✔️ | ✔️ | ✔️ |
| Single and Multiple Date Range | ✔️ | Ne | ✔️ |
...
|------|------|------|------|
| Odeslat | Send the filled form to the connected server. | Ano | Ano |
| Save as draft | Save a form that's not completed.  | Ano | Ano |
| Submit later | Mark a form as ready and send it to the Outbox tab.  | Ano | Ano |
| Drafts Tab | A tab with all drafts. Drafts can be edited or deleted.  | Ano | Ano |
| Outbox Tab | A tab with forms ready to submit. Forms on the outbox tab can be edited or deleted.  | Ano | Ano |
| Submitted Tab | A tab with all forms that have been successfully sent to the server. Submitted forms can be deleted.  | Ano | Ano |
| Pause/Resume submission | Users can manually pause a submission and resume it when ready.  | Ano | Ne |
| Automatically pause submission when offline | Submissions will be sent to the Outbox tab if submission fails due to connectivity issues.  | Ano | Ano |
