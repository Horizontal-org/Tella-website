...
## ဖိုင် စီမံခန့်ခွဲခြင်း - {/* #file-management */}
...
## အက်ပ်အတွင်း ထည့်သွင်းချိန်တွင် မက်တာဒေတာကို ထည့်သွင်းမည် {/* #preserve-metadata-when-importing */}
...
## အခြားအက်ပ် အသွင်ယူခြင်း {/* #camouflage */}
...
## အတည်ပြုခြင်းမုဒ် {/* #verification-mode */}
...
## ဗီဒီယို ပုံရိပ်ကြည်လင်ပြတ်သားမှု ရွေးပါ {/* #select-video-resolution */}
