...
အရပ်ဘက်အဖွဲ့အစည်းများနှင့် လူ့အခွင့်အရေး ကာကွယ်သူများအတွက် စိတ်ကြိုက်မေးခွန်းများပါသည့် ဖောင်များ ဖန်တီးရန်၊ အသုံးပြုသူများကို စီမံခန့်ခွဲရန်နှင့် အသုံးပြုသူများ ပေးပို့သော ဒေတာများကို စုစည်းရန်အတွက် [KoboToolbox](https://www.kobotoolbox.org/) ကို အသုံးပြုရန် အကြံပြုအပ်ပါသည်။ ကျွန်ုပ်တို့၏ အတွေ့အကြုံအရ KoboToolbox သည် အသုံးပြုရလွယ်ကူ၍ ပြုလွယ်ပြင်လွယ်ရှိပြီး ပွင့်လင်းအရင်းအမြစ်လည်းဖြစ်သည်။ KoboToolbox သည် အခမဲ့ [အသိုင်းအဝိုင်း အစီအစဉ်](https://www.kobotoolbox.org/pricing/) ကို အကျိုးအမြတ်အတွက်မဟုတ်သော အဖွဲ့အစည်းများအတွက် ပံ့ပိုးပေးပြီး ဆာဗာပေါ်တွင် ဒေတာတည်ဆောက်ပုံဆိုင်ရာ အခမဲ့ သင်တန်းရင်းမြစ်များနှင့် လမ်းညွှန်ချက်တို့ဖြင့် ပံ့ပိုးပါသည်။ [KoboToolbox ၏ သီးသန့်ဥပမာတစ်ခုကို အသုံးပြုခြင်း](https://www.kobotoolbox.org/services /private-servers/) သို့မဟုတ် [ကိုယ်တိုင်လက်ခံဆောင်ရွက်ပေးခြင်း](https://support.kobotoolbox.org/kobo_your_servers.html) ပြုလုပ်ပေးနိုင်ပါသည်။

[Ona](https://ona.io/home/) သို့မဟုတ် [ODK Cloud](https://getodk.org/index.html) ကဲ့သို့ ODK နှင့်ကိုက်ညီသော အခြားအက်ပ်များ ရှိပါသည်။ Tella သည် ဤအက်ပ်အားလုံးနှင့် အလုပ်လုပ်ပါသည်။ အကူအညီလိုအပ်ပါက [ကျွန်ုပ်တို့ထံ ဆက်သွယ်ပါ](contact-us) သို့မှသာ သင်အသုံးပြုသည့်ကိစ္စအတွက် အကောင်းဆုံးဆာဗာကို ရွေးချယ်နိုင်ရန် ကျွန်ုပ်တို့ ကူညီနိုင်ပါမည်။ 
...
| **Tella Android** | တစ်ခုရွေးပါ | 
|------|------|
| ✔️ | အများအပြားကို ရွေးပါ |
| ✔️ | စာသား |
| ✔️ | နံပါတ် / ဒသမ |
| ✔️ | နေ့စွဲ |
| ✔️ | အချိန် |
| ✔️ | ရက်စွဲနှင့် အချိန် |
| မဟုတ်ပါ | အမှတ် (ကျွန်ုပ်၏ လက်ရှိတည်နေရာကို တွက်ချက်ပါ)  |
| ✔️ | အမှတ် (မြေပုံပေါ်တွင် ကျွန်ုပ်၏ တည်နေရာကို ပြပါ) |
| ✔️ | အမှတ် (မြေပုံပေါ်တွင် ကျွန်ုပ်၏ တည်နေရာကို ရွေးချယ်ခွင့်ပြုပါ) |
| ✔️ | လိုင်း |
| မရှိပါ | ဧရိယာ |
| မရှိပါ | ဓာတ်ပုံ |
| ✔️ | ဓာတ်ပုံလက်မှတ် (ကျွန်တော့်လက်မှတ်ကို လက်ရေးဖြင့်ရေးပါ) |
| ✔️ | အသံ |
| ✔️ | ဗီဒီယို |
| ✔️ | ဖိုင် |
...
| ✔️ | ဘားကုဒ် / QR ကုဒ် |
| မရှိပါ | အသိအမှတ်ပြုပါ |
| ✔️ | အဆင့်သတ်မှတ်ချက် |
| ✔️ | မေးခွန်း ပုံသဏ္ဌာန် |
| မရှိပါ | အဆင့်သတ်မှတ်ချက် |
| ✔️ | တွက်ချက်မည် |
| မရှိပါ | ဝှက်ထားသော |
| မရှိပါ | အပိုင်းအခြား |
| မရှိပါ | ပြင်ပ XML |
| မရှိပါ | ပံ့ပိုးထားသော အင်္ဂါရပ်များ {#supported-features} |
...
| **Tella Android** | [အော့ဖ်လိုင်းဒေတာစုဆောင်းခြင်း](/odk#submit-forms) | 
|------|------|
| ✔️ | [ဖောင်လော့ဂျစ်](https://docs.getodk.org/form-logic/) |
| ❌ | [လိုအပ်သော တုံ့ပြန်မှုများ](https://docs.getodk.org/form-logic/#requiring-responses) |
| ✔️ | [မူရင်းတုံ့ပြန်မှုများကို သတ်မှတ်ခြင်း](https://docs.getodk.org/form-logic/#setting-default-responses) |
...
| ❌ | [အခြေအနေအလိုက် မေးခွန်းများကို ပြသခြင်း](https://docs.getodk.org/form-logic/#conditionally-showing-questions) |
| ✔️ | [မေးခွန်းအုပ်စုများ](https://docs.getodk.org/form-logic/#groups-of-questions) |
| ✔️ | [ထပ်နေသော မေးခွန်းများ](https://docs.getodk.org/form-logic/#repeating-questions) |
| ✔️ | [ရွေးချယ်ထားသော မေးခွန်းများတွင် ရွေးချယ်စရာများကို စိစစ်ခြင်း](https://docs.getodk.org/form-logic/#filtering-options-in-select-questions) |
| ✔️ | [ထပ်ခါတလဲလဲ ဒေတာထည့်သွင်းမှုများမှ ရွေးချယ်စရာများကို ဖန်တီးခြင်း](https://docs.getodk.org/form-logic/#generating-select-ones-from-repeats) |
