...
description: ပုံစံများကို အသုံးပြု၍ ဖွဲ့စည်းတည်ဆောက်ထားသော ဒေတာ စုဆောင်းလိုသည့် အဖွဲ့အစည်းများအတွက် Open Data Kit ဆာဗာချိတ်ဆက်မှု ရနိုင်ပါသည်။
slug: /odk
---

# Open Data Kit (ODK)

[Open Data Kit (ODK)](https://getodk.org/) သည် စိတ်ကြိုက်ပုံစံများဖန်တီးရန်နှင့် ဒေတာစုဆောင်းရန်အတွက် အသုံးပြုသည့် ပွင့်လင်းစံနှုန်းတစ်ခု ဖြစ်သည်။
...
အလားတူ အခြားသော ဆာဗာချိတ်ဆက်မှု ([Tella ဝဘ်](/tella-web) သို့မဟုတ် [Uwazi](/uwazi))၊ ODK ဆာဗာသို့ ချိတ်ဆက်ခြင်းသည် Tella တွင် စုဆောင်းထားသော ဒေတာလုံခြုံရေးကို တိုးမြှင့်ပေးသည်-
...
### သင်၏ ODK ဗဟိုဆာဗာကို ရွေးချယ်ခြင်းနှင့် ထည့်သွင်းခြင်း {#choosing-and-installing-your-odk-central-server}
...
အရပ်ဘက်အဖွဲ့အစည်းများနှင့် လူ့အခွင့်အရေး ကာကွယ်သူများအတွက် စိတ်ကြိုက်မေးခွန်းများပါသည့် ဖောင်များ ဖန်တီးရန်၊ အသုံးပြုသူများကို စီမံခန့်ခွဲရန်နှင့် အသုံးပြုသူများ ပေးပို့သော ဒေတာများကို စုစည်းရန်အတွက် [KoboToolbox](https://www.kobotoolbox.org/) ကို အသုံးပြုရန် အကြံပြုအပ်ပါသည်။ ကျွန်ုပ်တို့၏ အတွေ့အကြုံအရ KoboToolbox သည် အသုံးပြုရလွယ်ကူ၍ ပြုလွယ်ပြင်လွယ်ရှိပြီး ပွင့်လင်းရင်းမြစ်လည်းဖြစ်သည်။ KoboToolbox သည် [အခမဲ့ အများပြည်သူသုံး ဆာဗာ](https://kf.kobotoolbox.org/accounts/login/) ကို အကျိုးအမြတ်မယူဘဲ ပံ့ပိုးပေးပြီး ဆာဗာပေါ်တွင် ဒေတာတည်ဆောက်ပုံဆိုင်ရာ သင်တန်းနှင့် လမ်းညွှန်ချက်တို့ဖြင့် ပံ့ပိုးပါသည်။ [KoboToolbox ၏ သီးသန့်ဥပမာတစ်ခုကို အသုံးပြုရန်](https://www.kobotoolbox.org/services /private-servers/) သို့မဟုတ် [ကိုယ်တိုင်လက်ခံဆောင်ရွက်ပေးခြင်း] (https://support.kobotoolbox.org/kobo_your_servers .html) ပြုလုပ်ရန်ဖြစ်နိုင်ပါသည်။

[Ona](https://ona.io/home/) သို့မဟုတ် [ODK Cloud](https://getodk.org/index.html) ကဲ့သို့ ODK နှင့်ကိုက်ညီသော အခြားအက်ပ်များ ရှိပါသည်။ Tella သည် ဤအက်ပ်အားလုံးနှင့် အလုပ်လုပ်ပါသည်။ အကူအညီလိုအပ်ပါက၊ [ကျွန်ုပ်တို့ထံ ဆက်သွယ်ပါ](contact-us) သို့မှသာ သင့်အသုံးပြုမှုကိစ္စအတွက် အကောင်းဆုံးဆာဗာကို သင်ရွေးချယ်ရန် ကျွန်ုပ်တို့ ကူညီနိုင်ပါသည်။ 
...
ဤစာရွက်စာတမ်းတွင် ကျွန်ုပ်တို့သည် Tella ကို အသုံးပြု၍ မည်သို့ အချက်အလက်စုဆောင်းရမည်ကို အလေးပေးဖော်ပြပါသည်။ ODK Collect Android အက်ပ် အပါအဝင် ODK တွင် ဒေတာ စုဆောင်းရန် အသုံးပြုနိုင်သည့် အခြားမိုဘိုင်းအက်ပ်များ ရှိပါသည်။ ဤအခြားရွေးချယ်စရာများကို [ဤနေရာတွင်](/faq#how-is-tella-different-from-other- documentation -apps) နှိုင်းယှဉ်ကြည့်နိုင်ပါသည်။ 
...
ဒေတာစုဆောင်းပြီး ဖောင်ဖြည့်သည့်အခါ သင့်အတွက် အောက်ပါရွေးချယ်စရာများ ရှိပါသည်-
- တင်သွင်းပါ - ဖြည့်စွက်ပြီး ဖောင်ကို ODK ဆာဗာသို့ ပေးပို့ပါ။
- မူကြမ်းအဖြစ် သိမ်းဆည်းပါ - ဖြည့်စွက်မပြီးသေးသော ဖောင်ကို နောင်တွင် ဆက်ဖြည့်နိုင်ရန် သိမ်းဆည်းပေးသည်။
- နောက်မှ တင်သွင်းပါ- ဖောင်ကို နောင်တွင် တင်သွင်းရန် ဖြည့်စွက်ပြီးအဖြစ် အမှတ်အသားပြုပေးသည်။ ၎င်းကို မပို့မချင်း အထွက်ပုံးတက်ဘ်တွင် ရှိနေပါမည်။
- မူကြမ်းတက်ဘ် - ဖောင်မူကြမ်းအားလုံး စာရင်းပါရှိသော တက်ဘ်။ မူကြမ်းများကို တည်းဖြတ်နိုင်သည် သို့မဟုတ် ဖျက်နိုင်သည်။
- အထွက်ပုံးတက်ဘ် - ပေးပို့ရန် အဆင်သင့်ဖြစ်နေသော ဖောင်အားလုံး၏ စာရင်းပါရှိသည့် ဇယားတစ်ခု။ အထွက်တက်ဘ်ရှိ ဖောင်များကို တည်းဖြတ်နိုင်သည်၊ ဖျက်နိုင်သည် သို့မဟုတ် ပေးပို့နိုင်သည်။
- ပေးပို့ပြီး တက်ဘ်- ဆာဗာသို့ ပေးပို့ထားသော ဖောင်အားလုံး၏ စာရင်းကို ပြသသည့် တက်ဘ်တစ်ခု။ ပေးပို့ပြီးသော ဖောင်များကို ဖျက်နိုင်သည်။ 
...
- အော့ဖ်လိုင်းဖြစ်သည့်အခါ တင်သွင်းမှုကို အလိုအလျောက်ရပ်တန့်ပေးသည် - ချိတ်ဆက်မှုပြဿနာများကြောင့် တင်သွင်းမှု ပျက်ကွက်ပါက ဖောင်များကို အထွက်ပုံးတက်ဘ်သို့ လွှဲပြောင်းပေးပါမည်။
...
| [ရွေးချယ်ထားသော မေးခွန်းများတွင် ရွေးချယ်စရာများကို စိစစ်ခြင်း](https://docs.getodk.org/form-logic/#filtering-options-in-select-questions)
 | ✔️ |
