...
Tella တွင် ODK နှင့်ကိုက်ညီသော မည်သည့်ဆာဗာကိုမဆို အသုံးပြု၍ ဖောင်တစ်ခု ဖန်တီး၊ အသုံးပြုပြီးနောက် **ဆက်တင်များ** > **ဆာဗာများ** > **+** > **Open Data Kit (ODK)** သို့ သွားပြီး အောက်ပါ ကွက်လပ်များကို ဖြည့်စွက်ပါ- **ဆာဗာအမည်** - Tella ရှိ သင့်ဆာဗာအတွက် ဖော်ပြထားသည့် အမည်။ သင်ရွေးချယ်လိုက်သော အမည်ကို အက်ပ်အတွင်းတွင်သာ မြင်နိုင်ပြီး ODK ချိတ်ဆက်မှုကို မထိခိုက်ပါ။
...
| **မေးခွန်းအမျိုးအစား**                                         | **Tella Android** |
| -------------------------------------------------------------- | ----------------- |
| တစ်ခုရွေးပါ                                                    | ✔️                |
| အများအပြားကို ရွေးပါ                                           | ✔️                |
| စာသား                                                          | ✔️                |
| နံပါတ် / ဒသမ                                                   | ✔️                |
| နေ့စွဲ                                                         | ✔️                |
| အချိန်                                                         | ✔️                |
| ရက်စွဲနှင့် အချိန်                                             | မဟုတ်ပါ           |
| အမှတ် (ကျွန်ုပ်၏ လက်ရှိတည်နေရာကို တွက်ချက်ပါ)                  | ✔️                |
| အမှတ် (မြေပုံပေါ်တွင် ကျွန်ုပ်၏ တည်နေရာကို ပြပါ)               | ✔️                |
| အမှတ် (မြေပုံပေါ်တွင် ကျွန်ုပ်၏ တည်နေရာကို ရွေးချယ်ခွင့်ပြုပါ) | ✔️                |
| လိုင်း                                                         | မဟုတ်ပါ           |
| ဧရိယာ                                                          | မဟုတ်ပါ           |
| ဓာတ်ပုံ                                                        | ✔️                |
| ဓာတ်ပုံလက်မှတ် (ကျွန်တော့်လက်မှတ်ကို လက်ရေးဖြင့်ရေးပါ)         | ✔️                |
| အသံ                                                            | ✔️                |
| ဗီဒီယို                                                        | ✔️                |
| ဖိုင်                                                          | ✔️                |
| မှတ်စု                                                         | ✔️                |
| ဘားကုဒ် / QR ကုဒ်                                              | မဟုတ်ပါ           |
| အသိအမှတ်ပြုပါ                                                  | ✔️                |
| အဆင့်သတ်မှတ်ချက်                                               | ✔️                |
| မေးခွန်း ပုံသဏ္ဌာန်                                            | မဟုတ်ပါ           |
| အဆင့်သတ်မှတ်ချက်                                               | ✔️                |
| တွက်ချက်မည်                                                    | မဟုတ်ပါ           |
| ဝှက်ထားသော                                                     | မဟုတ်ပါ           |
| အပိုင်းအခြား                                                   | မဟုတ်ပါ           |
| ပြင်ပ XML                                                      | မဟုတ်ပါ           |
...
| **အင်္ဂါရပ်**                                                                                                                               | **Tella Android** |
| ------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| [အော့ဖ်လိုင်းဒေတာစုဆောင်းခြင်း](/odk#submit-forms)                                                                                          | ✔️                |
| [ဖောင်လော့ဂျစ်](https://docs.getodk.org/form-logic/)                                                                                        | ❌                 |
| [လိုအပ်သော တုံ့ပြန်မှုများ](https://docs.getodk.org/form-logic/#requiring-responses)                                                        | ✔️                |
| [မူရင်းတုံ့ပြန်မှုများကို သတ်မှတ်ခြင်း](https://docs.getodk.org/form-logic/#setting-default-responses)                                      | ❌                 |
| [တန်ဖိုးပြောင်းလဲမှုဆိုင်ရာ တွက်ချက်မှုများကို စတင်ခြင်း](https://docs.getodk.org/form-logic/#triggering-calculations-on-value-change)      | ❌                 |
| [တုံ့ပြန်မှုများကို အတည်ပြုခြင်းနှင့် ကန့်သတ်ခြင်း](https://docs.getodk.org/form-logic/#validating-and-restricting-responses)               | ❌                 |
| [အခြေအနေအလိုက် မေးခွန်းများကို ပြသခြင်း](https://docs.getodk.org/form-logic/#conditionally-showing-questions)                               | ✔️                |
| [မေးခွန်းအုပ်စုများ](https://docs.getodk.org/form-logic/#groups-of-questions)                                                               | ✔️                |
| [ထပ်နေသော မေးခွန်းများ](https://docs.getodk.org/form-logic/#repeating-questions)                                                            | ✔️                |
| [ရွေးချယ်ထားသော မေးခွန်းများတွင် ရွေးချယ်စရာများကို စိစစ်ခြင်း](https://docs.getodk.org/form-logic/#filtering-options-in-select-questions)  | ✔️                |
| [ထပ်ခါတလဲလဲ ဒေတာထည့်သွင်းမှုများမှ ရွေးချယ်စရာများကို ဖန်တီးခြင်း](https://docs.getodk.org/form-logic/#generating-select-ones-from-repeats) | ❌                 |
