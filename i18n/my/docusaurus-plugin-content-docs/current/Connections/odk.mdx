...
:::info ODK ချိတ်ဆက်မှုသည် Tella iOS အတွက် မရရှိနိုင်ပါ။ :::

### ODK ဆာဗာသို့ ချိတ်ဆက်ပါ {/* #connect-to-an-odk-server */}
...
### ပံ့ပိုးထားသော အင်္ဂါရပ်များ {/* #supported-features */}
