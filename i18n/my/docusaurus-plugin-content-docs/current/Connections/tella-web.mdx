...
:::info Our team can offer support with the installation, configuration, and maintenance of Tella Web. If you have any question or need support, [contact us](/contact-us/). :::

:::tip [Contact us](/contact-us/) to get access to our demo server, so you can test Tella Web before installing it on your own server. :::
...
:::info Take a look at [this video tutorial](/video-tutorials#connections-full-video) for a demo of how to set up Tella Web. :::
...
:::info အသုံးပြုသူများထံ သင်ပေးပို့ရမည့် URL သည် ဤသို့ ဖြစ်သင့်သည် `https://your-domain.com/p/your-project-name` :::
...
|                                                                 | သတင်းထောက် | ကြည့်ရှုသူ | အယ်ဒီတာ | အက်ဒမင် |
| --------------------------------------------------------------- | ---------- | ---------- | ------- | ------- |
| **Tella မိုဘိုင်းတွင်**                                         |            |            |         |         |
...
| အစီရင်ခံစာများကို တည်းဖြတ်ရန် (အမည်ပြောင်း)                     | ❌          | ❌          | ✅       | ✅       |
| အစီရင်ခံစာများကို ဖျက်ရန်                                       | ❌          | ❌          | ✅       | ✅       |
| ပရောဂျက်များကို တည်းဖြတ်ရန် (ဖန်တီး၊ အမည်ပြောင်း၊ URLတည်းဖြတ် ) | ❌          | ❌          | ✅       | ✅       |
| ပရောဂျက်များကို ဖျက်ရန်                                         | ❌          | ❌          | ✅       | ✅       |
| အသုံးပြုသူများကို စီမံခန့်ခွဲရန် (ဖန်တီး၊ တည်းဖြတ်၊ ဖျက်မည်)    | ❌          | ❌          | ❌       | ✅       |
| အသုံးပြုသူများကို ပရောဂျက်တွင် တာဝန်ပေးအပ်ရန်                   | ❌          | ❌          | ❌       | ✅       |
| ဤနေရာတွင် ရင်းမြစ်များကို ဖန်တီးပါ                              | ❌          | ❌          | ❌       | ✅       |
| ရင်းမြစ်များကို ပရောဂျက်တွင်/မှ ထည့်ပါ/ဖယ်ရှားပါ                | ❌          | ❌          | ✅       | ✅       |
| ရင်းမြစ်များ ကြည့်၍ ပရောဂျက် တာဝန်ပေးပါ                         | ❌          | ✅          | ✅       | ✅       |




#### အသုံးပြုသူများ ဖန်တီးခြင်း {/* #creating-users */}
...
"ပရောဂျက်ဆက်တင်များ" မျက်နှာပြင်၏ "ဝင်ရောက်ခွင့်ကို စီမံခန့်ခွဲရန်" ကဏ္ဍတွင် စီမံခန့်ခွဲသူများသည် လက်ရှိအသုံးပြုသူများအတွက် ပရောဂျက် သတ်မှတ်ပေးနိုင်ပါသည်။ "အသုံးပြုသူများ ထည့်ရန်" အကွက်ကို နှိပ်ပါ။ ဆွဲချမီနူးတစ်ခုသည် ဆာဗာပေါ်ရှိ အသုံးပြုသူအားလုံးကို ပြသပါမည်။ စာရင်းတွင် ရှာဖွေပါ သို့မဟုတ် အသုံးပြုသူအမည်ဖြင့် ရှာဖွေပါ။ ပရောဂျက်သို့ ထည့်ရန် အသုံးပြုသူများကို ရွေးချယ်ပြီးနောက် အပြောင်းအလဲများကို သိမ်းဆည်းရန်နှင့် ပရောဂျက်သို့ ဝင်ရောက်ခွင့်ပေးရန် "ထည့်ရန်" ခလုတ်ကို နှိပ်ပါ။

:::info ပရောဂျက်သို့ အစီရင်ခံစာများ တင်သွင်းနိုင်သည့် အသုံးပြုသူစာရင်း အပြည့်အစုံ၌ ဤကဏ္ဍတွင် ဖော်ပြထားသော အသုံးပြုသူများအပြင် ဆာဗာစီမံခန့်ခွဲသူအားလုံး ပါဝင်ပါသည်။ :::

### ရင်းမြစ်များကို စီမံခန့်ခွဲခြင်း {/* #managing-resources */}

Tella ဝဘ်သည် အဖွဲ့အစည်းများအား Tella ၏ ကုဒ်ဝှက်ထားသော ထည့်စရာနေရာအတွင်း၌ ရင်းမြစ်များနှင့် စာရွက်စာတမ်းများကို လုံခြုံစွာ ခွဲခြမ်းပြီး ၎င်းတို့၏ အသုံးပြုသူများထံ တိုက်ရိုက်ပို့ဆောင်ခွင့် ပြုသည်။ ဒေတာ စုစည်းရယူရန် လမ်းညွှန်ချက်များ၊ မက်ဆေ့ချ်များ သို့မဟုတ် ဒေတာစုစည်းရယူရန် လမ်းညွှန်များ တင်ရန်အတွက် ရင်းမြစ်များကို အသုံးပြုနိုင်သည်။

#### ရင်းမြစ်များကို ဤနေရာတွင် ဖန်တီးခြင်း {/* #creating-resources-to-the-space */}

စီမံခန့်ခွဲသူများသည် **ရင်းမြစ်များ** ဘယ်ဘက်ဘေးဘားသို့ သွား၍ ဤနေရာတွင် ရင်းမြစ်များ ဖန်တီးနိုင်သည်။ လက်ရှိတွင် PDF များ အပ်လုဒ်တင်၍ ရင်းမြစ်များ ဖန်တီးနိုင်သည်။ အသံုံးပြုသူများက အင်တာနက် နှေးကွေးချိန်တွင် ၎င်းတို့ကို ဒေါင်းလုဒ်လုပ်နိုင်ရန်အတွက် ထိုရင်းမြစ်များကို 20MB အောက် ထားရှိရန် ကျွနု်ပ်တို့ အကြံပြုပါသည်။

ရင်းမြစ်များကို ဤနေရာတွင် မျှဝေသည်။ ရင်းမြစ်များကို သက်ဆိုင်ရာ ပရောဂျက်များသို့ ထည့်ပြီးမှသာ အသုံးပြုသူမ်ျားက ရရှိနိုင်ကြောင်း သတိပြုပါ။
...
* အစီရင်ခံစာများကို [Tella-FOSS]{1} တွင် မရရှိနိုင်သေးပါ။

Reports are not yet available on [Tella-FOSS](/faq#is-tella-available-on-f-droid).

:::info You can watch [this video](/video-tutorials#tella-web) on how to configure and use Reports in Tella. :::


#### Tella ဝဘ်ပရောဂျက်များ သို့ ချိတ်ဆက်မည် {/* #connect-to-tella-web-projects */}
...
* (အက်ဒမင်များမှ ထုတ်လုပ်ပြီး ပံ့ပိုးပေးသည့်) လော့ဂ်အင် အချက်အလက်ကို ထည့်သွင်းပါ
...
:::info အင်တာနက်ချိတ်ဆက်မှု ပြတ်တောက်သွားပါက အစီရင်ခံစာများကို အထွက်ပုံးတဘ်သို့ ရွှေ့မည်ဖြစ်ပြီး တင်သွင်းမှုလုပ်ငန်းစဉ်ကို ကိုယ်တိုင် ပြန်လည်စတင်ရပါမည်။ :::
...
:::info အလိုအလျောက်အစီရင်ခံစာကို တစ်ကြိမ်လျှင် ပရောဂျက်တစ်ခုအတွက်သာ ဖွင့်နိုင်သည် :::
