...
import {Tip, Warning, Danger, Info} from '@site/src/components/Admonitions';
...
အခြားချိတ်ဆက်မှုအားလုံး ([Uwazi](/uwazi) နှင့် [Open Data Kit](/g-drive)) ကဲ့သို့ပင် Tella Web သို့ ချိတ်ဆက်ခြင်းသည် Tella တွင် စုဆောင်းထားသော ဒေတာလုံခြုံရေးကို တိုးမြှင့်ပေးသည်-
