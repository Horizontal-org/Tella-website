...
| Numeric | ✔️ | ✔️ | ✔️ |
| Single Select  | ✔️ | ✔️ | ✔️ | 
| Multiple Select  | ✔️ | خیر | ✔️ | 
| Relationship | ✔️ | ✔️ | ✔️ |
| Single Date | ✔️ | ✔️ | ✔️ |
| Multiple Date | ✔️ | خیر | ✔️ |
| External Link | ✔️ | خیر | ✔️ |
| Rich Text | ✔️ | ✔️ | ✔️ |
| Single and Multiple Date Range | ✔️ | خیر | ✔️ |
| Attach Media (Image, Video, or Audio) | ✔️| ✔️ | ✔️ |
| Geolocation | ✔️ | خیر | ✔️ |
| Generated ID  | ✔️ | خیر | ✔️ |
...
|------|------|------|------|
| ارسال | Send the filled form to the connected server. | بله | بله |
| Save as draft | Save a form that's not completed.  | بله | بله |
| Submit later | Mark a form as ready and send it to the Outbox tab.  | بله | بله |
| Drafts Tab | A tab with all drafts. Drafts can be edited or deleted.  | بله | بله |
| Outbox Tab | A tab with forms ready to submit. Forms on the outbox tab can be edited or deleted.  | بله | بله |
| Submitted Tab | A tab with all forms that have been successfully sent to the server. Submitted forms can be deleted.  | بله | بله |
| Pause/Resume submission | Users can manually pause a submission and resume it when ready.  | بله | خیر |
| Automatically pause submission when offline | Submissions will be sent to the Outbox tab if submission fails due to connectivity issues.  | بله | بله |
