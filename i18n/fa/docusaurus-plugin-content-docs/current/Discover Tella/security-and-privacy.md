...
| تاریخ | Audited by | Platforms audited  | پیوند      |
| -----|----------|----|-----------|
...
| عنوان                                               | شدت    | پلتفرم | وضعیت      |
|-----------------------------------------------------|-------------|-------------|-------------|
| Require re-authentication for changing key security settings | Moderate      | عمومی | Planning |
| Improve webview implementation                      |  Moderate   | آی‌او‌اس       | Resolved |
| Improve GitHub practices (merging to main and tags) | کم         | Android, Android FOSS | Resolved (pending re-test) |
| Increase PBKDF2 iteration counts.                   | کم         | Android, Android FOSS | Soon |
| Do not allow clear-text traffic in Android manifest.| کم         | Android, Android FOSS | Resolved |
| Outdated 3rd-party dependencies                     | نمی‌دانم         | Android, Android FOSS | Resolved |
