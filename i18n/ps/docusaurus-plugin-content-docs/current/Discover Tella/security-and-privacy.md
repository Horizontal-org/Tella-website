...
| نېټه | Audited by | Platforms audited  | Link      |
| -----|----------|----|-----------|
...
| عنوان                                               | شدت    | Platform | وضعیت      |
|-----------------------------------------------------|-------------|-------------|-------------|
| Require re-authentication for changing key security settings | Moderate      | ټوليز | Planning |
| Improve webview implementation                      |  Moderate   | iOS       | Resolved |
| Improve GitHub practices (merging to main and tags) | ټیټ         | Android, Android FOSS | Resolved (pending re-test) |
| Increase PBKDF2 iteration counts.                   | ټیټ         | Android, Android FOSS | Soon |
| Do not allow clear-text traffic in Android manifest.| ټیټ         | Android, Android FOSS | Resolved |
