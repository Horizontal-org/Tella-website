...
Here there are some criteria about when Uwazi could be great for your use case:
- You need to publish the registered information as open data in a public website.
- You need to establish relationships between data elements.
- If data must be contained in structured database registers.
...
- You need to preserve information in an extremely secura and/or long term way.
