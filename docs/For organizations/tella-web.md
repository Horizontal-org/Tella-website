...
To ensure that users have access to the reporting feature, please verify that your Tella app version is either of these versions or a more recent one. Reports are not yet available on [Tella-FOSS](/faq#is-tella-available-on-f-droid).
