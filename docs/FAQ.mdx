...
Yes, we published a version of Tella Android [on F-Droid](https://f-droid.org/en/packages/org.hzontal.tellaFOSS/). On this version, all features are available except for:
