...
- To use [verification mode](/features#verification-mode) or send your location, you will need to grant access to your device location. You can do this by going into Tella’s settings and then General > Verification Mode.
