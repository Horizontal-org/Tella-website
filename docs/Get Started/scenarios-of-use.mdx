...
- [Verification mode](/features#verification-mode): Tella automatically captures verification information (file metadata), which can be used to corroborate evidence. Verification information can identify the user and their device, so only share it if doing so will not put you or others at risk.
