...
:::danger
Even though data is transferred to the server securely (SSL), anyone with access to the Uwazi account can view them. If you need encrypted file transfers, explore [Nearby Sharing](/nearby-sharing).
:::
