...
Thank you for your interest in helping us with translations. Many of the translations in the Tella ecosystem (including this documentation) has been added by people like you, who wanted to contribute to the Tella project.
 

If you never did translations before, if you need guidance on our translation platforms or if you would like to contribute to multiple projects in the Internet Freedom ecosystem, we recommend you to join the [Localization Lab community](#localization-lab-community).

### Contribute to the Tella translations {/* #contribute-to-the-tella-translations */}

We use Weblate to manage all Tella translations.

1. Create an account in [Localization Lab's Weblate](https://localizationlab.weblate.cloud/accounts/register/). 
2. Join the [Tella project](https://localizationlab.weblate.cloud/projects/tella-new/).
3. Follow this [Weblate Platform Quick Guide](https://static1.squarespace.com/static/542b02d7e4b0a92b527f5750/t/69a80930a116594dee3e457c/1772620103157/Localization+Lab_+Weblate+Platform+Quick+Guide.pdf).
