...
### iOS: Tella 3.2.0 (152) - Released on August 10, 2026 {/* #ios-tella-320152---released-on-aug-10-2026 */}
- Uwazi connection improvements:
    - Made sure that Primary Documents allows PDF selection from both Tella Vault or the device.
    - Allowed Supporting Documents to include all types of file selection from the Tella Vault or de device.
    - Made sure to update Draft, Outbox and New entities templates when pressing the "Refresh Templates" button.
- Migrated translation management to Weblate. 
- Bug fixes and minor improvements:
    - Refactored all the app's strings format to maximize translation memory usage.
...
### iOS: Tella 3.0.0 (144) - Released on May 20, 2026 { /*#ios-tella-300144---released-on-may-20-2026 */} {/* #ios-tella-300-144---released-on-may-20-2026--ios-tella-300144---released-on-may-20-2026- */}
- Implemented [Nearby Sharing](/nearby-sharing): Nearby Sharing lets users securely share files in physical proximity. Nearby Sharing is fully offline, available across platforms and devices, and assures end-to-end encryption. 
- Implemented security fixes detected by our most recent security audit (to be published soon!).
- New languages support: Ukrainian.
- Bug fixes and minor improvements:
