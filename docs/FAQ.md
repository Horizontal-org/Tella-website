...
All code, libraries, and dependencies in Tella FOSS are entirely Free and Open Source Software (FOSS). Tella FOSS only include an opt-in [privacy preserving analytics](/security-and-privacy#analytics) tracker.
