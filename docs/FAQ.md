...
:::note
Note that it is not possible to encrypt and hide files or create reports on Tella Web. These features are only available on the mobile apps. Tella Web will be one of the options available to collect data from Tella ([see connections](TODO) ).
:::
