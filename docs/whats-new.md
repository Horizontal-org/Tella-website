...
### Android: Tella 2.7.0 (?) - Released on March X, 2024 {#android-tella-270-?---released-on-march-X-2024}
...
- Technical maintanance tasks:
  - Bugfixing
  - Refactoed the Tella Web project's screen to use the new navigation activity.
