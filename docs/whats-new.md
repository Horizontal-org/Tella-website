...
### Android: Tella 3.0.0 (X) - Released on X X, 2025 {#android-tella-300X---released-on-x-x-2025}
- Added [Nearby Sharing](/nearby-sharing), our solution for offline file sharing, encrypted and anonymous directly from a Tella vault to another one (phone-to-phone and phone-to-computer).


### iOS: Tella 3.0.0 (X) - Released on X X, 2025 {#ios-tella-300X---released-on-x-x-2025}
- Added [Nearby Sharing](/nearby-sharing), our solution for offline file sharing, encrypted and anonymous directly from a Tella vault to another one (phone-to-phone and phone-to-computer).
...
### Android: Tella 2.17.0 (209) - Released on August 6, 2025 {#android-tella-21170209---released-on-aug-6-2025}
...
- Bug fixes:
    ...
    - Simplified the implementation of the Camera Silent Mode and the shutter sound to make it work in all devices.
